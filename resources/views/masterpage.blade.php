              ...
              @if (Auth::user()->role_type == "GA")
                  <li class="treeview" id="menu_master">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li id="submenu_productions"><a href="{{url('productions')}}"><i class="fa fa-cubes"></i> Add Production House</a></li>
                      </ul>
                  </li>
                @endif

                <li id="menu_movie"><a href="{{url('movie/')}}"><i class="fa fa-first-order"></i> <span>Movie</span></a></li>
